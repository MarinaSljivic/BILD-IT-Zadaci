...
public class LeapYear {
	...
	public static void main(String[] args) {
		...
		int countLeapYears = 0; // counts how many leap years there are from 101
								// to 2100.

		for (int year = 101; year <= 2100; year++) { // we start from 101 year
														// to 2100 year
			...
			if (isLeapYear) { // if its true, then print it
				...
				if (countLeapYears % 10 == 0) { // if we have a number of leap
												// years that
		...
		System.out.println("\n\nFrom 101 to 2100 there are " + countLeapYears
				+ " leap years.");
